...
const getAllBooksFromBD = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateBookToDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const getReviews = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = isExist === null || isExist === void 0 ? void 0 : isExist.reviews;
    return result;
});
exports.BookService = {
    getAllBooksFromBD,
