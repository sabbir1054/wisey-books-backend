...
const getWishlist = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      isExist === null || isExist === void 0 ? void 0 : isExist.wishlist;
    return result;
  });
const getReadSoon = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      isExist === null || isExist === void 0 ? void 0 : isExist.readSoon;
    return result;
  });
const getFinished = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield user_model_1.User.findById(id).populate(
      'finishedBook'
    );
    if (!isExist) {
      throw new ApiErrors_1.default(
    ...
    const result =
      isExist === null || isExist === void 0 ? void 0 : isExist.finishedBook;
    return result;
  });
